...
export function SettingsForm({ weightUnit, timerTriggerMode }: Props) {
  ...
  return (
    <form action={formAction} className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Unidad de peso</label>
        <select
          name="weight_unit"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Modo de timer</label>
        <select
